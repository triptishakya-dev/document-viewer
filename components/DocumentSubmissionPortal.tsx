  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="text-center">
        <h1 className="text-4xl font-extrabold text-white mb-3 tracking-tight">Submit Document</h1>
        ...
        {!file ? (
          ...
          >
            ...
            <div className="relative border-2 border-dashed border-slate-700/50 rounded-2xl p-12 text-center transition-all duration-300 hover:border-purple-500/50 hover:bg-slate-800/20">
              ...
              <h3 className="text-lg font-semibold text-white mb-1">Click or drag PDF here</h3>
